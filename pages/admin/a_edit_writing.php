    ...
    <div class="container">
        ...
        <div class="card bg-black border-secondary border-opacity-25 shadow-lg">
            <div class="card-body p-4">
                <form action="<?php echo BASE_URL; ?>iras-mentes" method="POST" id="postForm">
                    ...
                    <div class="mb-4">
                        <label for="title" class="form-label small text-secondary-emphasis text-uppercase fw-bold">Írás címe</label>
                        <input type="text" id="title" name="title" class="form-control bg-black border-secondary text-white p-3" placeholder="Add meg az írás címét..." value="<?php echo htmlspecialchars($old['title'] ?? ($postData['cim'] ?? '')); ?>" required>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-5">
                        ...
                        <button type="submit" class="btn btn-danger px-5 fw-bold">ÍRÁS KÖZZÉTÉTELE</button>
                    </div>
                </form>
            </div>
        </div>
