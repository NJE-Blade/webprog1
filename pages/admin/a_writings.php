...
<section id="blog-admin" class="bg-black">
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="<?php echo BASE_URL; ?>admin/iras-szerkesztes" class="btn btn-danger px-4 shadow fw-bold">
                <i class="bi bi-plus-square me-2"></i> ÚJ ÍRÁS
            </a>
        </div>
                ...
                <table class="table table-hover align-middle m-0 text-white">
                    ...
                    <tbody>
                        <?php if (empty($blogPosts)): ?>
                            <tr>
                                <td colspan="4" class="text-center py-4 text-muted">Még nincsenek írások.</td>
                            </tr>
                        <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <form action="<?php echo BASE_URL; ?>admin/iras-szerkesztes" method="POST" class="d-inline">
        ...
        <div class="modal-content bg-black border border-danger shadow-lg">
            ...
            <form action="<?php echo BASE_URL; ?>bejegyzes-torles" method="POST">
                ...
                <div class="modal-body p-4 text-light" style="font-family: 'Crimson Text', serif; font-size: 1.2rem;">
                    Biztosan véglegesen törölni akarod ezt az írást? Ez a művelet nem vonható vissza.
                </div>
