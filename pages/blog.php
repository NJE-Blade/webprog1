...
$post = null;
if ($postId > 0) {
    $post = $db->getPostWithAuthor($postId);
}
...
<section class="bg-black py-4">
        <div class="container">
            <div class="mb-2">
                <a href="<?php echo BASE_URL; ?>blog" class="text-danger text-decoration-none"><i class="bi bi-arrow-left"></i> Vissza a blogokhoz</a>
            </div>
            ...
            <div class="d-flex gap-3 blog-article-meta text-muted mb-4">
                ...
                <span><i class="bi bi-person"></i> <?php echo htmlspecialchars($post['szerzo_neve'] ?? 'Vaszilij'); ?></span>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center text-muted">
                ...
                <a href="<?php echo BASE_URL; ?>blog" class="btn btn-outline-danger btn-sm"><i class="bi bi-arrow-left"></i> Összes blog</a>
            </div>
        </div>
    </section>